...
const App = () => {
  ...
  return (
    <div className="w-[1170px] mx-auto font-sans p-5">
      <Header />
      <Main />
      ...
      <div className="grid gap-5 grid-cols-[repeat(auto-fill,_minmax(250px,_1fr))]">
        ...
        <div
            key={product.id}
            className="border border-gray-200 rounded-lg p-4 shadow-sm flex flex-col max-w-[270px]"
          >
            <div className="w-full h-44 bg-gray-100 flex justify-center items-center mb-4 rounded overflow-hidden">
              <img
                src={product.img}
                alt={product.name}
            ...
            <button className="bg-black text-white border-0 py-2 rounded cursor-pointer font-medium mt-auto hover:bg-red-700 transition">
              Add To Cart
            </button>
